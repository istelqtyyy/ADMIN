...
if (isset($_POST['change_password'])) {
    ...
    $stmt->bind_param('si', $newPassword, $userId); // 'si' means the first parameter is a string, and the second is an integer

    if ($stmt->execute()) {
        header("Location: finance3.php"); // Redirect after updating password
        exit();
    } else {
...
<head>
    ...
    <style>
        ...
        button:hover {
            background-color: #ffca2c; /* Darker yellow */
        }
...
<body>
    ...
    <div class="back-button">
        <a href="finance3.php">Back to Finance Accounts</a>
    </div>
