...
$success_message = '';
$error_message = '';
$metric = ''; // Initialize the $metric variable
...
<head>
    ...
    <!-- Add FontAwesome CDN for home icon -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" />
</head>

<body>

    <a href="../core/core5.php" class="home-icon">
    ...
    <div class="form-container">
        <form action="" method="post">
            ...
            <?php for ($i = 1; $i <= 8; $i++) : ?>
                ...
                <input type="number" name="product<?= $i ?>" id="product<?= $i ?>" step="0.01" placeholder="Enter Product <?= $i ?> Sales" required>
            <?php endfor; ?>
            <button type="submit">Update Product Sales</button>
        </form>
    </div>

    <div class="message <?php echo !empty($success_message) ? 'success' : (!empty($error_message) ? 'error' : ''); ?>">
        <?php
